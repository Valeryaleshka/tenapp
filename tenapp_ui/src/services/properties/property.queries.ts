...
export const propertyQueryKeys = {
    ...
    list: (page: number, pageSize: number, sortBy: PropertySortField, sortDir: SortDirection, search: string) =>
...
export function usePropertiesQuery(
    ...
    return useQuery({
        ...
        queryFn: ({ signal }) => propertyService.getAll(page, pageSize, sortBy, sortDir, search, signal),
    });
}
